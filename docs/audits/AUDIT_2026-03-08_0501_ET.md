...
- generated_at_et: 2026-03-08T05:01:35-0400
...
```text
main
?? docs/audits/AUDIT_2026-03-08_0501_ET.md
?? docs/audits/lynx/2026-03-08_0501_ET_chokidar.txt
?? docs/audits/lynx/2026-03-08_0501_ET_reactflow_layouting.txt
?? docs/audits/lynx/2026-03-08_0501_ET_reactflow_performance.txt
...
fe8dabb chore(nebula): hourly maintainer sync 2026-03-08 02:07:06.880 UTC
58e0ad7 chore(nebula): hourly maintainer sync 2026-03-08 02:02:09.730 UTC
```
...
apps/web/src/universe/ReactFlowOverlay.tsx:430:    const engine = chooseLayout({
apps/web/src/universe/ReactFlowOverlay.tsx:449:        const out = layoutWithDagre(graphSnapshot.nodes, graphSnapshot.edges, "LR");
apps/web/src/universe/ReactFlowOverlay.tsx:454:      const out = await layoutWithElk(graphSnapshot.nodes, graphSnapshot.edges, isMobile ? "DOWN" : "RIGHT");
apps/web/src/universe/ReactFlowOverlay.tsx:464:  const focusNode = useCallback(
apps/web/src/universe/ReactFlowOverlay.tsx:468:      focusNodeRef.current = nodeId;
apps/web/src/universe/ReactFlowOverlay.tsx:492:  const onConnect = useCallback<OnConnect>(
apps/web/src/universe/ReactFlowOverlay.tsx:504:  const onNodeClick = useCallback(
apps/web/src/universe/ReactFlowOverlay.tsx:510:          toggleExpandedNode(parentId);
apps/web/src/universe/ReactFlowOverlay.tsx:511:          focusNode(parentId, { duration: 260, padding: isMobile ? 0.44 : 0.32, maxZoom: isMobile ? 0.9 : 1.1 });
apps/web/src/universe/ReactFlowOverlay.tsx:521:        toggleExpandedNode(node.id);
apps/web/src/universe/ReactFlowOverlay.tsx:524:      focusNode(node.id, { duration: 260, padding: isMobile ? 0.44 : 0.32, maxZoom: isMobile ? 0.9 : 1.1 });
apps/web/src/universe/ReactFlowOverlay.tsx:526:    [focusId, focusNode, isMobile, revealNode, toggleExpandedNode]
apps/web/src/universe/ReactFlowOverlay.tsx:534:      const focused = focusNodeRef.current;
apps/web/src/universe/ReactFlowOverlay.tsx:587:      <ReactFlow
apps/web/src/universe/ReactFlowOverlay.tsx:590:        onNodeClick={onNodeClick}
apps/web/src/universe/ReactFlowOverlay.tsx:591:        onConnect={onConnect}
apps/web/src/universe/ReactFlowOverlay.tsx:608:      </ReactFlow>
...
- reactflow performance: docs/audits/lynx/2026-03-08_0501_ET_reactflow_performance.txt
- reactflow layouting: docs/audits/lynx/2026-03-08_0501_ET_reactflow_layouting.txt
- chokidar reference: docs/audits/lynx/2026-03-08_0501_ET_chokidar.txt
