...
- generated_at_et: 2026-03-07T13:00:43-0500
...
f3ad8ee chore(nebula): hourly maintainer sync 2026-03-07 16:07:12.355 UTC
6e63e97 chore(nebula): hourly maintainer sync 2026-03-07 16:02:05.006 UTC
```
...
apps/web/src/universe/ReactFlowOverlay.tsx:117:  const focusNodeRef = useRef<string | null>(null);
...
apps/web/src/universe/ReactFlowOverlay.tsx:365:      focusNodeRef.current = nodeId;
...
apps/web/src/universe/ReactFlowOverlay.tsx:398:      focusNode(node.id, { duration: 260, padding: isMobile ? 0.44 : 0.32, maxZoom: isMobile ? 0.9 : 1.1 });
apps/web/src/universe/ReactFlowOverlay.tsx:400:    [focusNode, isMobile, toggleExpandedNode]
apps/web/src/universe/ReactFlowOverlay.tsx:411:      const focused = focusNodeRef.current;
apps/web/src/universe/ReactFlowOverlay.tsx:463:              const focused = focusNodeRef.current ?? focusId ?? graphSnapshot.focus ?? laidOut.nodes[0]?.id ?? graphSnapshot.nodes[0]?.id;
apps/web/src/universe/ReactFlowOverlay.tsx:465:                focusNode(focused, { duration: 240, padding: isMobile ? 0.48 : 0.34, maxZoom: isMobile ? 0.92 : 1.12 });
...
- reactflow performance: docs/audits/lynx/2026-03-07_1300_ET_reactflow_performance.txt
- reactflow layouting: docs/audits/lynx/2026-03-07_1300_ET_reactflow_layouting.txt
- chokidar reference: docs/audits/lynx/2026-03-07_1300_ET_chokidar.txt
