...
- generated_at_et: 2026-03-07T14:01:31-0500
...
main
 ...
 M apps/server/src/universe/index.ts
...
?? docs/audits/AUDIT_2026-03-07_1401_ET.md
?? docs/audits/lynx/2026-03-07_1401_ET_chokidar.txt
?? docs/audits/lynx/2026-03-07_1401_ET_reactflow_layouting.txt
?? docs/audits/lynx/2026-03-07_1401_ET_reactflow_performance.txt
?? implementation.d
?? scripts/tts-router/
...
607bd89 feat(mobile-flow): restore node jump and add up/down branch expansion heuristic
3e8bfd7 fix(mobile-flow): auto-fit viewport on expand/select for unified tree view
```
...
apps/web/src/universe/layoutEngines.ts:25:export function layoutWithRadial(nodes: Node[], edges: Edge[]): { nodes: Node[]; edges: Edge[] } {
apps/web/src/universe/layoutEngines.ts:47:export function layoutWithDagre(nodes: Node[], edges: Edge[], direction: "TB" | "LR" = "LR"): { nodes: Node[]; edges: Edge[] } {
apps/web/src/universe/layoutEngines.ts:70:export async function layoutWithElk(
...
apps/web/src/universe/ReactFlowOverlay.tsx:103:export const ReactFlowOverlay = memo(function ReactFlowOverlay({ enabled }: { enabled: boolean }) {
apps/web/src/universe/ReactFlowOverlay.tsx:108:  const toggleExpandedNode = useUniverseGraphStore((s) => s.toggleExpandedNode);
apps/web/src/universe/ReactFlowOverlay.tsx:109:  const setFocusId = useUniverseGraphStore((s) => s.setFocusId);
apps/web/src/universe/ReactFlowOverlay.tsx:115:  const [rf, setRf] = useState<ReactFlowInstance | null>(null);
apps/web/src/universe/ReactFlowOverlay.tsx:119:  const focusNodeRef = useRef<string | null>(null);
apps/web/src/universe/ReactFlowOverlay.tsx:284:    const autoEngine = chooseLayout({
apps/web/src/universe/ReactFlowOverlay.tsx:310:        const out = layoutWithDagre(graphSnapshot.nodes, graphSnapshot.edges, "LR");
apps/web/src/universe/ReactFlowOverlay.tsx:315:      const out = await layoutWithElk(graphSnapshot.nodes, graphSnapshot.edges, isMobile ? undefined : "RIGHT");
apps/web/src/universe/ReactFlowOverlay.tsx:325:  const onConnect = useCallback<OnConnect>(
apps/web/src/universe/ReactFlowOverlay.tsx:335:  const focusNode = useCallback(
apps/web/src/universe/ReactFlowOverlay.tsx:339:      setFocusId(nodeId);
apps/web/src/universe/ReactFlowOverlay.tsx:340:      focusNodeRef.current = nodeId;
apps/web/src/universe/ReactFlowOverlay.tsx:361:    [isMobile, rf, setFocusId]
apps/web/src/universe/ReactFlowOverlay.tsx:364:  const onNodeClick = useCallback(
apps/web/src/universe/ReactFlowOverlay.tsx:370:        toggleExpandedNode(node.id);
apps/web/src/universe/ReactFlowOverlay.tsx:373:      focusNode(node.id, { duration: 260, padding: isMobile ? 0.44 : 0.32, maxZoom: isMobile ? 0.9 : 1.1 });
apps/web/src/universe/ReactFlowOverlay.tsx:375:    [focusNode, isMobile, toggleExpandedNode]
apps/web/src/universe/ReactFlowOverlay.tsx:386:      const focused = focusNodeRef.current;
apps/web/src/universe/ReactFlowOverlay.tsx:438:              const focused = focusNodeRef.current ?? focusId ?? graphSnapshot.focus ?? laidOut.nodes[0]?.id ?? graphSnapshot.nodes[0]?.id;
apps/web/src/universe/ReactFlowOverlay.tsx:440:                focusNode(focused, { duration: 240, padding: isMobile ? 0.48 : 0.34, maxZoom: isMobile ? 0.92 : 1.12 });
apps/web/src/universe/ReactFlowOverlay.tsx:458:      <ReactFlow
apps/web/src/universe/ReactFlowOverlay.tsx:461:        onNodeClick={onNodeClick}
apps/web/src/universe/ReactFlowOverlay.tsx:462:        onConnect={onConnect}
apps/web/src/universe/ReactFlowOverlay.tsx:475:      </ReactFlow>
...
- reactflow performance: docs/audits/lynx/2026-03-07_1401_ET_reactflow_performance.txt
- reactflow layouting: docs/audits/lynx/2026-03-07_1401_ET_reactflow_layouting.txt
- chokidar reference: docs/audits/lynx/2026-03-07_1401_ET_chokidar.txt
