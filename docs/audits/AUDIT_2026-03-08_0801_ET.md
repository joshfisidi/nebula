...
- generated_at_et: 2026-03-08T08:01:31-0400
...
```text
main
?? docs/audits/AUDIT_2026-03-08_0801_ET.md
?? docs/audits/lynx/2026-03-08_0801_ET_chokidar.txt
?? docs/audits/lynx/2026-03-08_0801_ET_reactflow_layouting.txt
?? docs/audits/lynx/2026-03-08_0801_ET_reactflow_performance.txt
...
ca4b5bc chore(nebula): hourly maintainer sync 2026-03-08 05:07:08.471 UTC
17f74a8 chore(nebula): hourly maintainer sync 2026-03-08 05:02:12.422 UTC
```
...
apps/web/src/universe/graphStore.ts:35:  toggleExpandedNode: (nodeId: string) => void;
apps/web/src/universe/graphStore.ts:36:  setFocusId: (nodeId: string | null) => void;
apps/web/src/universe/graphStore.ts:135:export const useUniverseGraphStore = create<UniverseGraphState>((set, get) => ({
apps/web/src/universe/graphStore.ts:271:  toggleExpandedNode(nodeId) {
apps/web/src/universe/graphStore.ts:280:  setFocusId(nodeId) {
...
apps/web/src/universe/ProjectViewerPanel.tsx:21:export function ProjectViewerPanel() {
...
apps/web/src/universe/ReactFlowOverlay.tsx:169:export const ReactFlowOverlay = memo(function ReactFlowOverlay({ enabled }: { enabled: boolean }) {
apps/web/src/universe/ReactFlowOverlay.tsx:178:  const toggleExpandedNode = useUniverseGraphStore((s) => s.toggleExpandedNode);
apps/web/src/universe/ReactFlowOverlay.tsx:185:  const [rf, setRf] = useState<ReactFlowInstance | null>(null);
apps/web/src/universe/ReactFlowOverlay.tsx:189:  const focusNodeRef = useRef<string | null>(null);
apps/web/src/universe/ReactFlowOverlay.tsx:468:    const engine = chooseLayout({
apps/web/src/universe/ReactFlowOverlay.tsx:487:        const out = layoutWithDagre(graphSnapshot.nodes, graphSnapshot.edges, "LR");
apps/web/src/universe/ReactFlowOverlay.tsx:492:      const out = await layoutWithElk(graphSnapshot.nodes, graphSnapshot.edges, isMobile ? "DOWN" : "RIGHT");
apps/web/src/universe/ReactFlowOverlay.tsx:502:  const focusNode = useCallback(
apps/web/src/universe/ReactFlowOverlay.tsx:506:      focusNodeRef.current = nodeId;
apps/web/src/universe/ReactFlowOverlay.tsx:539:  const onConnect = useCallback<OnConnect>(
apps/web/src/universe/ReactFlowOverlay.tsx:551:  const onNodeClick = useCallback(
apps/web/src/universe/ReactFlowOverlay.tsx:557:          toggleExpandedNode(parentId);
apps/web/src/universe/ReactFlowOverlay.tsx:558:          focusNode(parentId, { duration: 260, padding: isMobile ? 0.44 : 0.32, maxZoom: isMobile ? 0.9 : 1.1 });
apps/web/src/universe/ReactFlowOverlay.tsx:567:      focusNode(node.id, { duration: 260, padding: isMobile ? 0.44 : 0.32, maxZoom: isMobile ? 0.9 : 1.1 });
apps/web/src/universe/ReactFlowOverlay.tsx:569:    [focusNode, isMobile, revealNode, toggleExpandedNode]
apps/web/src/universe/ReactFlowOverlay.tsx:589:      const focused = focusNodeRef.current;
apps/web/src/universe/ReactFlowOverlay.tsx:655:      <ReactFlow
apps/web/src/universe/ReactFlowOverlay.tsx:658:        onNodeClick={onNodeClick}
apps/web/src/universe/ReactFlowOverlay.tsx:659:        onConnect={onConnect}
apps/web/src/universe/ReactFlowOverlay.tsx:676:      </ReactFlow>
apps/web/src/universe/UniverseScene.tsx:8:import { ReactFlowOverlay } from "./ReactFlowOverlay";
apps/web/src/universe/UniverseScene.tsx:113:export function UniverseScene() {
apps/web/src/universe/UniverseScene.tsx:128:        <ReactFlowOverlay enabled />
...
- reactflow performance: docs/audits/lynx/2026-03-08_0801_ET_reactflow_performance.txt
- reactflow layouting: docs/audits/lynx/2026-03-08_0801_ET_reactflow_layouting.txt
- chokidar reference: docs/audits/lynx/2026-03-08_0801_ET_chokidar.txt
