...
- generated_at_et: 2026-03-09T12:01:29-0400
...
```text
main
?? docs/audits/AUDIT_2026-03-09_1201_ET.md
?? docs/audits/lynx/2026-03-09_1201_ET_chokidar.txt
?? docs/audits/lynx/2026-03-09_1201_ET_reactflow_layouting.txt
?? docs/audits/lynx/2026-03-09_1201_ET_reactflow_performance.txt
...
4fd3a18 chore(nebula): hourly maintainer sync 2026-03-09 09:02:53.797 UTC
```
...
apps/web/src/universe/ReactFlowOverlay.tsx:557:  const onConnect = useCallback<OnConnect>(
apps/web/src/universe/ReactFlowOverlay.tsx:569:  const onNodeClick = useCallback(
apps/web/src/universe/ReactFlowOverlay.tsx:575:          toggleExpandedNode(parentId);
apps/web/src/universe/ReactFlowOverlay.tsx:576:          focusNode(parentId, { duration: 260, padding: isMobile ? 0.44 : 0.32, maxZoom: isMobile ? 0.9 : 1.1 });
apps/web/src/universe/ReactFlowOverlay.tsx:585:        toggleExpandedNode(node.id);
apps/web/src/universe/ReactFlowOverlay.tsx:586:        focusNode(node.id, { duration: 260, padding: isMobile ? 0.44 : 0.32, maxZoom: isMobile ? 0.9 : 1.1 });
apps/web/src/universe/ReactFlowOverlay.tsx:591:      focusNode(node.id, { duration: 260, padding: isMobile ? 0.44 : 0.32, maxZoom: isMobile ? 0.9 : 1.1 });
apps/web/src/universe/ReactFlowOverlay.tsx:593:    [focusNode, isMobile, revealNode, toggleExpandedNode]
apps/web/src/universe/ReactFlowOverlay.tsx:613:      const focused = focusNodeRef.current;
apps/web/src/universe/ReactFlowOverlay.tsx:679:      <ReactFlow
apps/web/src/universe/ReactFlowOverlay.tsx:682:        onNodeClick={onNodeClick}
apps/web/src/universe/ReactFlowOverlay.tsx:683:        onConnect={onConnect}
apps/web/src/universe/ReactFlowOverlay.tsx:700:      </ReactFlow>
...
- reactflow performance: docs/audits/lynx/2026-03-09_1201_ET_reactflow_performance.txt
- reactflow layouting: docs/audits/lynx/2026-03-09_1201_ET_reactflow_layouting.txt
- chokidar reference: docs/audits/lynx/2026-03-09_1201_ET_chokidar.txt
