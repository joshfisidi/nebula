...
- generated_at_et: 2026-03-08T09:01:32-0400
...
?? docs/audits/AUDIT_2026-03-08_0901_ET.md
?? docs/audits/lynx/2026-03-08_0901_ET_chokidar.txt
?? docs/audits/lynx/2026-03-08_0901_ET_reactflow_layouting.txt
?? docs/audits/lynx/2026-03-08_0901_ET_reactflow_performance.txt
...
1cc0cf7 chore(nebula): hourly maintainer sync 2026-03-08 06:07:09.103 UTC
39b86b1 chore(nebula): hourly maintainer sync 2026-03-08 06:02:18.894 UTC
```
...
apps/web/src/universe/layoutEngines.ts:28:export function layoutWithDagre(nodes: Node[], edges: Edge[], direction: "TB" | "LR" = "LR") {
apps/web/src/universe/layoutEngines.ts:62:export async function layoutWithElk(nodes: Node[], edges: Edge[], direction?: "RIGHT" | "DOWN") {
apps/web/src/universe/layoutEngines.ts:95:export function layoutWithRadial(nodes: Node[], edges: Edge[], rootId?: string) {
...
apps/web/src/universe/ReactFlowOverlay.tsx:477:    const engine = chooseLayout({
apps/web/src/universe/ReactFlowOverlay.tsx:496:        const out = layoutWithDagre(graphSnapshot.nodes, graphSnapshot.edges, "LR");
apps/web/src/universe/ReactFlowOverlay.tsx:501:      const out = await layoutWithElk(graphSnapshot.nodes, graphSnapshot.edges, isMobile ? "DOWN" : "RIGHT");
apps/web/src/universe/ReactFlowOverlay.tsx:511:  const focusNode = useCallback(
apps/web/src/universe/ReactFlowOverlay.tsx:515:      focusNodeRef.current = nodeId;
apps/web/src/universe/ReactFlowOverlay.tsx:548:  const onConnect = useCallback<OnConnect>(
apps/web/src/universe/ReactFlowOverlay.tsx:560:  const onNodeClick = useCallback(
apps/web/src/universe/ReactFlowOverlay.tsx:566:          toggleExpandedNode(parentId);
apps/web/src/universe/ReactFlowOverlay.tsx:567:          focusNode(parentId, { duration: 260, padding: isMobile ? 0.44 : 0.32, maxZoom: isMobile ? 0.9 : 1.1 });
apps/web/src/universe/ReactFlowOverlay.tsx:576:        toggleExpandedNode(node.id);
apps/web/src/universe/ReactFlowOverlay.tsx:577:        focusNode(node.id, { duration: 260, padding: isMobile ? 0.44 : 0.32, maxZoom: isMobile ? 0.9 : 1.1 });
apps/web/src/universe/ReactFlowOverlay.tsx:582:      focusNode(node.id, { duration: 260, padding: isMobile ? 0.44 : 0.32, maxZoom: isMobile ? 0.9 : 1.1 });
apps/web/src/universe/ReactFlowOverlay.tsx:584:    [focusNode, isMobile, revealNode, toggleExpandedNode]
apps/web/src/universe/ReactFlowOverlay.tsx:604:      const focused = focusNodeRef.current;
apps/web/src/universe/ReactFlowOverlay.tsx:670:      <ReactFlow
apps/web/src/universe/ReactFlowOverlay.tsx:673:        onNodeClick={onNodeClick}
apps/web/src/universe/ReactFlowOverlay.tsx:674:        onConnect={onConnect}
apps/web/src/universe/ReactFlowOverlay.tsx:691:      </ReactFlow>
```
...
- reactflow performance: docs/audits/lynx/2026-03-08_0901_ET_reactflow_performance.txt
- reactflow layouting: docs/audits/lynx/2026-03-08_0901_ET_reactflow_layouting.txt
- chokidar reference: docs/audits/lynx/2026-03-08_0901_ET_chokidar.txt
