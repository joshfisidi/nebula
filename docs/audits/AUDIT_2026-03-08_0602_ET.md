...
- generated_at_et: 2026-03-08T06:02:51-0400
...
?? docs/audits/AUDIT_2026-03-08_0602_ET.md
?? docs/audits/lynx/2026-03-08_0602_ET_chokidar.txt
?? docs/audits/lynx/2026-03-08_0602_ET_reactflow_layouting.txt
?? docs/audits/lynx/2026-03-08_0602_ET_reactflow_performance.txt
...
6a5eada chore(nebula): hourly maintainer sync 2026-03-08 03:07:07.532 UTC
2032cd7 chore(nebula): hourly maintainer sync 2026-03-08 03:03:29.522 UTC
```
...
apps/web/src/universe/ProjectViewerPanel.tsx:31:  const toggleExpandedNode = useUniverseGraphStore((s) => s.toggleExpandedNode);
apps/web/src/universe/ProjectViewerPanel.tsx:162:              onClick={() => toggleExpandedNode(node.id)}
...
apps/web/src/universe/ReactFlowOverlay.tsx:167:export const ReactFlowOverlay = memo(function ReactFlowOverlay({ enabled }: { enabled: boolean }) {
apps/web/src/universe/ReactFlowOverlay.tsx:176:  const toggleExpandedNode = useUniverseGraphStore((s) => s.toggleExpandedNode);
apps/web/src/universe/ReactFlowOverlay.tsx:183:  const [rf, setRf] = useState<ReactFlowInstance | null>(null);
apps/web/src/universe/ReactFlowOverlay.tsx:187:  const focusNodeRef = useRef<string | null>(null);
apps/web/src/universe/ReactFlowOverlay.tsx:434:    const engine = chooseLayout({
apps/web/src/universe/ReactFlowOverlay.tsx:453:        const out = layoutWithDagre(graphSnapshot.nodes, graphSnapshot.edges, "LR");
apps/web/src/universe/ReactFlowOverlay.tsx:458:      const out = await layoutWithElk(graphSnapshot.nodes, graphSnapshot.edges, isMobile ? "DOWN" : "RIGHT");
apps/web/src/universe/ReactFlowOverlay.tsx:468:  const focusNode = useCallback(
apps/web/src/universe/ReactFlowOverlay.tsx:472:      focusNodeRef.current = nodeId;
apps/web/src/universe/ReactFlowOverlay.tsx:505:  const onConnect = useCallback<OnConnect>(
apps/web/src/universe/ReactFlowOverlay.tsx:517:  const onNodeClick = useCallback(
apps/web/src/universe/ReactFlowOverlay.tsx:523:          toggleExpandedNode(parentId);
apps/web/src/universe/ReactFlowOverlay.tsx:524:          focusNode(parentId, { duration: 260, padding: isMobile ? 0.44 : 0.32, maxZoom: isMobile ? 0.9 : 1.1 });
apps/web/src/universe/ReactFlowOverlay.tsx:534:        toggleExpandedNode(node.id);
apps/web/src/universe/ReactFlowOverlay.tsx:537:      focusNode(node.id, { duration: 260, padding: isMobile ? 0.44 : 0.32, maxZoom: isMobile ? 0.9 : 1.1 });
apps/web/src/universe/ReactFlowOverlay.tsx:539:    [focusId, focusNode, isMobile, revealNode, toggleExpandedNode]
apps/web/src/universe/ReactFlowOverlay.tsx:559:      const focused = focusNodeRef.current;
apps/web/src/universe/ReactFlowOverlay.tsx:625:      <ReactFlow
apps/web/src/universe/ReactFlowOverlay.tsx:628:        onNodeClick={onNodeClick}
apps/web/src/universe/ReactFlowOverlay.tsx:629:        onConnect={onConnect}
apps/web/src/universe/ReactFlowOverlay.tsx:646:      </ReactFlow>
```
...
- reactflow performance: docs/audits/lynx/2026-03-08_0602_ET_reactflow_performance.txt
- reactflow layouting: docs/audits/lynx/2026-03-08_0602_ET_reactflow_layouting.txt
- chokidar reference: docs/audits/lynx/2026-03-08_0602_ET_chokidar.txt
