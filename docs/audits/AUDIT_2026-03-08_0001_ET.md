...
- generated_at_et: 2026-03-08T00:01:29-0500
...
```text
main
?? docs/audits/AUDIT_2026-03-08_0001_ET.md
?? docs/audits/lynx/2026-03-08_0001_ET_chokidar.txt
?? docs/audits/lynx/2026-03-08_0001_ET_reactflow_layouting.txt
?? docs/audits/lynx/2026-03-08_0001_ET_reactflow_performance.txt
...
apps/web/src/universe/layoutEngines.ts:23:export function layoutWithDagre(nodes: Node[], edges: Edge[], direction: "TB" | "LR" = "LR") {
apps/web/src/universe/layoutEngines.ts:57:export async function layoutWithElk(nodes: Node[], edges: Edge[], direction?: "RIGHT" | "DOWN") {
...
apps/web/src/universe/ReactFlowOverlay.tsx:16:import { chooseLayout, layoutWithDagre, layoutWithElk, type LayoutEngine, type LayoutMode } from "./layoutEngines";
apps/web/src/universe/ReactFlowOverlay.tsx:102:export const ReactFlowOverlay = memo(function ReactFlowOverlay({ enabled }: { enabled: boolean }) {
apps/web/src/universe/ReactFlowOverlay.tsx:107:  const toggleExpandedNode = useUniverseGraphStore((s) => s.toggleExpandedNode);
apps/web/src/universe/ReactFlowOverlay.tsx:108:  const setFocusId = useUniverseGraphStore((s) => s.setFocusId);
apps/web/src/universe/ReactFlowOverlay.tsx:114:  const [rf, setRf] = useState<ReactFlowInstance | null>(null);
apps/web/src/universe/ReactFlowOverlay.tsx:118:  const focusNodeRef = useRef<string | null>(null);
apps/web/src/universe/ReactFlowOverlay.tsx:279:    const autoEngine = chooseLayout({
apps/web/src/universe/ReactFlowOverlay.tsx:291:        const out = layoutWithDagre(graphSnapshot.nodes, graphSnapshot.edges, "LR");
apps/web/src/universe/ReactFlowOverlay.tsx:296:      const out = await layoutWithElk(graphSnapshot.nodes, graphSnapshot.edges, isMobile ? undefined : "RIGHT");
apps/web/src/universe/ReactFlowOverlay.tsx:306:  const onConnect = useCallback<OnConnect>(
apps/web/src/universe/ReactFlowOverlay.tsx:316:  const focusNode = useCallback(
apps/web/src/universe/ReactFlowOverlay.tsx:320:      setFocusId(nodeId);
apps/web/src/universe/ReactFlowOverlay.tsx:321:      focusNodeRef.current = nodeId;
apps/web/src/universe/ReactFlowOverlay.tsx:342:    [isMobile, rf, setFocusId]
apps/web/src/universe/ReactFlowOverlay.tsx:345:  const onNodeClick = useCallback(
apps/web/src/universe/ReactFlowOverlay.tsx:351:        toggleExpandedNode(node.id);
apps/web/src/universe/ReactFlowOverlay.tsx:354:      focusNode(node.id, { duration: 260, padding: isMobile ? 0.44 : 0.32, maxZoom: isMobile ? 0.9 : 1.1 });
apps/web/src/universe/ReactFlowOverlay.tsx:356:    [focusNode, isMobile, toggleExpandedNode]
apps/web/src/universe/ReactFlowOverlay.tsx:367:      const focused = focusNodeRef.current;
apps/web/src/universe/ReactFlowOverlay.tsx:419:              const focused = focusNodeRef.current ?? focusId ?? graphSnapshot.focus ?? laidOut.nodes[0]?.id ?? graphSnapshot.nodes[0]?.id;
apps/web/src/universe/ReactFlowOverlay.tsx:421:                focusNode(focused, { duration: 240, padding: isMobile ? 0.48 : 0.34, maxZoom: isMobile ? 0.92 : 1.12 });
apps/web/src/universe/ReactFlowOverlay.tsx:439:      <ReactFlow
apps/web/src/universe/ReactFlowOverlay.tsx:442:        onNodeClick={onNodeClick}
apps/web/src/universe/ReactFlowOverlay.tsx:443:        onConnect={onConnect}
apps/web/src/universe/ReactFlowOverlay.tsx:456:      </ReactFlow>
...
- reactflow performance: docs/audits/lynx/2026-03-08_0001_ET_reactflow_performance.txt
- reactflow layouting: docs/audits/lynx/2026-03-08_0001_ET_reactflow_layouting.txt
- chokidar reference: docs/audits/lynx/2026-03-08_0001_ET_chokidar.txt
